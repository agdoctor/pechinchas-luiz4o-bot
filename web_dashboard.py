                        ...
                        <div id="store-ml" style="padding: 16px; display:none; background: var(--bg-sec);">
                            ...
                            <label style="font-size:12px; font-weight:bold;">Tag do Afiliado:</label>
                             <div style="margin-bottom:14px">
                                 <input id="aff-ML_AFFILIATE_TAG" type="text" placeholder="ex: drmkt" style="width:100%">
                             </div>
        ...
        <script>
            ...
            async function loadAfiliados() {{
                const keys = ['SHOPEE_APP_ID', 'SHOPEE_APP_SECRET', 'SHOPEE_AFFILIATE_ID', 'SHOPEE_SOURCE_ID',
                              'ML_AFFILIATE_TAG', 'ML_AFFILIATE_COOKIE',
'ALI_APP_KEY', 'ALI_APP_SECRET', 'ALI_TRACKING_ID', 'AMAZON_TAG'];
                for (const k of keys) {{
                    try {{
...
async def handle_rewrite_tg(request):
    ...
    try:
        ...
        texto_com_nossos_links, placeholder_map = await process_and_replace_links(text, link_orig)
